...
public class VocaAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener, ItemMoveCallback.ItemTouchHelperContract {

    private Context context;
    private ArrayList<VoVoca> dataList;

    public VocaAdapter2(ArrayList<VoVoca> dataList) {
